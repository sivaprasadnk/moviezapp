...
class MovieDetailsScreenOld extends StatefulWidget {
  const MovieDetailsScreenOld({super.key});
  static const routeName = "/MovieDetails";
  @override
  State<MovieDetailsScreenOld> createState() => _MovieDetailsScreenOldState();
}

class _MovieDetailsScreenOldState extends State<MovieDetailsScreenOld> {
